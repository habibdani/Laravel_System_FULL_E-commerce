    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/productDetail-script.js',
                ...
                'resources/js/api/fetchPencarianProduct.js',
    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                productDetailScript: 'resources/js/productDetail-script.js',
                ...
                fetchPencarianProduct: 'resources/js/api/fetchPencarianProduct.js',
