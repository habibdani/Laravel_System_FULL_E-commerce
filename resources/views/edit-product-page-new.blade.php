        ...
        <div class="flex-1 p-4">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <button id="save_button" class="bg-red-600 text-white px-4 py-2 rounded">Edit Produk</button>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', async function () {
            try {
                ...
                if (result.success) {
                    ...
                    // Isi field basic information
                    document.getElementById('product_name').value = data.original.product.full_name_product; // Nama Produk
                    document.getElementById('price_1').value = data.original.product.price; // Harga
                    document.getElementById('stock_1').value = data.original.product.stock; // Stok
                    document.getElementById('product_variant_description_1').value = data.original.product.descriptions; // Deskripsi

                    // Gambar produk
                    const imagePreview = document.getElementById('editImagePreview');
                    imagePreview.src = `http://127.0.0.1:8001/storage/${data.product.variant_image}`;
                    imagePreview.classList.remove('hidden'); // Tampilkan jika sebelumnya disembunyikan

                    // Dropdown kategori (diambil dari product_utama)
                    ...
                    productTypeOption.value = data.product_utama.product_type_id;
                    productTypeOption.textContent = data.product_utama.product_name;
                    dropdownCategory.appendChild(productTypeOption);
