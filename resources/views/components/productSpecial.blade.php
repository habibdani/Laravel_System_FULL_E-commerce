<section name="special-product" id="sessionproductspecial" class="py-0 mt-8">
    <div class="parallax-appear">
        <div class="flex flex-col items-center justify-center mx-auto w-full h-full">
            <div id="subsessionproductspecial" class="relative w-[1200px] flex items-center justify-between">
...
<style>
    ...
    #special-product-list::-webkit-scrollbar-thumb:hover {
    ...
    button#prev-button-product-special:hover,
    button#next-button-product-special:hover {
