        ...
        <div class="flex items-center justify-center w-[994px] space-x-[40px]">
            ...
            <div class="shadow-custom w-[720px] h-[223px] p-4 flex items-center rounded-md space-x-[70px]">
                <div class="ml-[10px]">
                    ...
                    <a href="mailto:team@andalprima.co.id" class="flex items-center justify-center w-[95px] h-[28.5px] inline-block bg-red-600 font-roboto text-[14px] font-normal text-white rounded">Contact Us</a>
                </div>
