        ...
        <div class="flex items-center justify-center w-[994px] space-x-[30px]">
            ...
            <div class="shadow-custom w-[720px] h-[223px] p-4 flex items-center rounded-md space-x-[70px]">
                <div class="ml-[10px]">
                    ...
                    <a href="mailto:team@andalprima.co.id" class="flex items-center justify-center w-[95px] h-[28.5px] inline-block bg-[#00AA5B] font-roboto text-[14px] font-normal text-white rounded">Contact Us</a>
                </div>
            ...
            <div class=" relative w-[245px] h-[223px] shadow-custom bg-cover rounded-md bg-center p-4 text-center" style="background-image: url('{{ asset('storage/images/em9YuIaleCIngKzyqiVgvpJWiT514QZoKh1Xzxzr.jpg') }}');">
                ...
                <a class=" inline-block font-poppins bg-white text-[16px] text-[#00AA5B] flex items-center justify-center h-[30px] w-[179px] rounded font-semibold">Total 75% Discount!</a>
            </div>
        </div>
    </div>
</section>
