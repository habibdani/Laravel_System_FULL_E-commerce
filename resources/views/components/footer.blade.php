<footer class=" py-0 mt-8">
    ...
    <div class="mx-auto p-2 bg-[#00AA5B] w-[994px] text-white h-[121.86px] rounded-lg flex items-center justify-between">
        ...
        <div class="flex flex-col items-center w-1/4 h-full justify-center">
        ...
        <div class="flex flex-col items-start w-1/3 h-full justify-center">
        ...
        <div class="flex flex-col items-start w-1/4 h-full justify-center">
            <div class="flex items-center space-x-2 mb-2">
                <img src="{{ asset('storage/icons/clock.svg') }}" alt="clock" class="max-h-full w-auto h-[20px]">
                <span class="font-roboto text-[14px] font-normal leading-4.5 tracking-wide text-left">Monday – Saturday <br> 07:30 – 16:30</span>
            </div>
