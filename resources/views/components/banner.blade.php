<section name="banner" class="py-0 mt-8">
    <div class="parallax-appear">
        ...
        <div class="flex flex-col items-center justify-center mx-auto w-full h-full">
            <div id="subbanner" class="relative w-[90%] h-[480px] mt-20 shadow-custom bg-cover rounded-md bg-center overflow-hidden" style="background-image: linear-gradient(180deg, #000000 -36.47%, rgba(28, 28, 28, 0.595) 35.86%, rgba(68, 68, 68, 0) 100%), url('{{ asset('storage/images/I5jwMQectdlYcOFz3EqJqhNzgcPzBWAnJHCW4FHn.jpg') }}');">
                <!-- Tombol kiri -->
